...
def plot_centers(
    ...
    *,
    ...
    ax.set_ylabel(r"Centre $C = \frac{\delta_+ + \delta_-}{2}$", fontsize=fontsize)
    ax.tick_params(labelsize=fontsize - 2)
    ax.legend(title="Model", fontsize=fontsize - 2)
    fig.tight_layout()
...
def plot_acceptance(
    ...
    *,
    ...
    ax.grid(alpha=0.3)
    ax.set_xlabel(r"Normalised Chromaticity $\xi$", fontsize=fontsize)
    ax.set_ylabel(r"Acceptance $A = \delta_+ - \delta_-$", fontsize=fontsize)
    ax.tick_params(labelsize=fontsize - 2)
    ax.legend(title="Model", fontsize=fontsize - 2)
    fig.tight_layout()
